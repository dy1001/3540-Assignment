...
def exercise04(more_temperatures, iot_sensor_points, a, b, c, d, e):
    ...
    for t in more_temperatures:
        temperatures.append(t)

    for v in iot_sensor_points:
        temperatures.append(iot_sensor_points[v])
    ...
    for x in range (0,len_tem):
        if (x+1)%5 == 0:
            samples.append(temperatures[x])
...
def display_menu(menu):
    ...
    user_input = input('select a menu item by entering a number and hitting Enter')
    num_of_input = 1
    while user_input != 'N':
...
class TestAssignment2(unittest.TestCase):
    ...
    def test_exercise04(self):
        ...
        samples, temperatures, more_temperatures, iot_sensor_points, a, b, c, d, e, copy_of_samples = exercise04(more_temperatures, iot_sensor_points, 8000, 8500, 9000, 9500, 9999)
